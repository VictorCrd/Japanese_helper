...
def helper():
    ...
    if request.method == "POST":
        ...
        if "youtube" in request.form:
            ...
            for i in range(0, 10):
                top_10.loc[i:i+1, ('Known word')] = '<a href="#" name="%d" id="add"><button class="btn-small waves-effect waves-light blue darken-1" type="submit" title="Add this word to known words, this word wont be shown next time you encouter it">Add</button></a>' %(i)
            ...
            return render_template("helper.html", top_10_words=top_10.to_html(escape=False),
                                   ...
                                   video_id = video_id, known_words=df_top_10_known_words.to_html(escape=False))
